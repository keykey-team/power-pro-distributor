                ...
                <div className='prod-modal'>
                    <div className="prod-modal__content">
                        ...
                        <div className="prod-modal__data">
                            ...
                            <p className='prod-modal__data-subtitle'>Zloženie</p>
                            <p className='prod-modal__data-description'>Mliečna bielkovinová zmes 38% (srvátkový bielkovinový koncentrát (mlieko), srvátkový bielkovinový izolát (mlieko), vo vode rozpustná kukuričná vláknina, poleva 17% (kakaové maslo, sušené plnotučné mlieko, sladidlá: maltitol, glykozidy steviolu), kokosový tuk, kešu oriešky, pistácie 2%, arašidy, prírodná aróma, vitamín E. Môže obsahovať vajcia.</p>
