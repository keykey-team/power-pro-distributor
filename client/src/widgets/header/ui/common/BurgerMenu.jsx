    ...
    return (
        <>
            ...
            <div className={isModalOpen === "burger" ? "burger-menu active" : "burger-menu"}>
                ...
                <p className='burger-menu__contact'>  <a href="mailto:objednavkyfitwinpowerpro@gmail.com">objednavkyfitwinpowerpro@gmail.com</a></p>
                <p className='burger-menu__contact'><a href="tel:+421917874360">+421 917 874 360</a></p>
                <button className='preview__button' onClick={() => { router.push("/build-box"); setIsModalOpen(null) }}>{t("box")}</button>
            </div>
