...
import { scrollToOrderForm } from '../lib/scrollToOrderForm';
...
export function Header({ locale }) {
    ...
    useEffect(() => {
        ...
        // Подписка на изменения в других вкладках (storage event)
        window.addEventListener('storage', updateCartCount);

        // Кастомное событие для обновления внутри текущей вкладки
        ...
        <header className='header'>
            <div className="header__content container">
                ...
                <div className="header__func">
                    <div className="header__curt" onClick={() => scrollToOrderForm()}>
                        ...
                        <div className="header__curt-count">
                            <p>{cartCount}</p> {/* 👈 используем состояние */}
                        </div>
                    </div>
